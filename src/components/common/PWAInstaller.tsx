  ...
  return (
    <div className="fixed bottom-4 right-4 z-50">
      <button
        ...
        className="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg shadow-lg flex flex-col items-center space-y-1 transition-all duration-200 transform hover:scale-105"
        aria-label={`Install ${currentPage} as PWA`}
      >
        <div className="flex items-center space-x-2">
          ...
          <span className="font-semibold">Install {currentPage}</span>
        </div>
