    ...
    <>
      ...
      <div>
        ...
        <div className="relative">
          <select
            {...register("Salutation", { required: t.salutation_required || "Vui lòng chọn xưng hô." })}
        ...
        {errors.Salutation && (
          <p className="text-red-600 text-xs sm:text-sm mt-1 sm:mt-2 font-medium flex items-center">
            ...
            {typeof errors.Salutation?.message === "string"
              ...
              : (t.salutation_required || "Vui lòng chọn xưng hô.")}
          </p>
        )}
      </div>
      ...
      <div>
        ...
        <input
          ...
          {...register("Full_Name", { required: t.full_name_required || "Vui lòng nhập họ và tên." })}
        ...
        {errors.Full_Name && (
          <p className="text-red-600 text-xs sm:text-sm mt-1 sm:mt-2 font-medium flex items-center">
            ...
            {typeof errors.Full_Name?.message === "string"
              ...
              : (t.full_name_required || "Vui lòng nhập họ và tên.")}
          </p>
        )}
      </div>
      ...
      <div>
        ...
        <input
          ...
          {...register("Email", { 
            required: t.email_required || "Vui lòng nhập email.",
            pattern: {
              value: /^[^\s@]+@[^\s@]+\.[^\s@]+$/,
        ...
        {errors.Email && (
          <p className="text-red-600 text-xs sm:text-sm mt-1 sm:mt-2 font-medium flex items-center">
            ...
            {typeof errors.Email?.message === "string"
              ...
              : (t.email_required || "Vui lòng nhập email hợp lệ.")}
          </p>
        )}
      </div>
      ...
      <div>
        ...
        <input
          ...
          {...register("Phone_Number", { 
            required: t.phone_required || "Vui lòng nhập số điện thoại.",
            pattern: {
              value: /^[0-9+\-\s\(\)]{10,15}$/,
        ...
        {errors.Phone_Number && (
          <p className="text-red-600 text-xs sm:text-sm mt-1 sm:mt-2 font-medium flex items-center">
            ...
            {typeof errors.Phone_Number?.message === "string"
              ...
              : (t.phone_required || "Vui lòng nhập số điện thoại hợp lệ.")}
          </p>
        )}
      </div>
    </>
