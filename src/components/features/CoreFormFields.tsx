...
export default function CoreFormFields({ register, errors, t = {} }: Props) {
  const baseInputClass = "w-full px-4 py-3 border-2 border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 bg-white text-gray-900 font-medium";
      ...
      <div>
        ...
        <div className="relative">
          <select
            ...
            className={`appearance-none ${baseInputClass} pr-12 ${errors.Salutation ? 'border-red-500 focus:ring-red-500' : ''}`}
          >
