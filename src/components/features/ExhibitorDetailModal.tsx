...
export default function ExhibitorDetailModal({ exhibitor, onClose, onMatching, currentLanguage = 'vi' }: ExhibitorDetailModalProps) {
          ...
          <div className="grid grid-cols-3 gap-2">
            {onMatching && (
              ...
              >
                ...
                <span className="text-xs font-medium">{i18n[currentLanguage]?.['Matching'] || 'Matching'}</span>
              </button>
            )}
            {getWebsiteUrl() && (
              <button
